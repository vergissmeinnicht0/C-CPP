/* Code：OriginalCoder 
   Debug：OriginalCoder 
   设计和后期开发：OriginalCoder 
   支持：软件B1801班 */
                             
							   /* 开发者前言 */

/* 该图书管理系统V1.0是武汉传媒学院传媒技术学院软件B1801班OriginalCoder原创,可以随意使用源码,
   但至少署下我的名字尊重一下我的原创,谢谢理解!!! */
/* 如果你发现了代码运行过程中的bug或者error,请联系我,我的邮箱是original9@foxmail.com */
...
int main()
{
	...
	system("title 软件1801-OriginalCoder");
...
{
	system("cls");
	printf("Code:  OriginalCoder\n");
	printf("Debug: OriginalCoder\n");
	printf("\n\n\t\t使用帮助请查看用户手册或程序猿手册!");
	printf("\n\n");
 	printf(" ^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^**^*^*^*^*^*^*^*^*^\n");
	printf(" | 该图书管理系统经过几经周折,时间原因等,里面可能会有些傻傻的地方或者bug! |\n");
	printf(" * 如果大家发现了,一定要联系我哦!我的邮箱是original9@foxmail.com,笔芯!!!  *\n");
	printf(" |                                ^_^                                     |\n");
	printf(" ^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^**^*^*^*^*^*^*^*^*^\n");
	printf("\n\n按任意键退出.");
	getch();
